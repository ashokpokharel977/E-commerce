							...
							<div class="col-sm-3">
								<div class="db-listing-wrap">
									<ul>
										...
										<li class="active"><a href="javascript:void(0);"><i class="fa fa-database"></i> My Products</a></li>
							...
							<div class="col-sm-9">
								<div class="db-content-wrap">
									<div class="purches-counter">
										<ul>
											<li class="active"><a href=""><span>0</span> Active Products</a></li>
											<li><a href=""><span>0</span> Waiting for approval</a></li>
											<li><a href=""><span>0</span> Cancelled Products</a></li>
											<li><a href=""><i class="fa fa-tags"></i> Sell Now</a></li>
										</ul>
									</div>
									<div class="pending-product-listing">
										<div class="row">
											<div class="col-sm-4 col-item-list">
