							...
							<div class="col-sm-3">
								<div class="db-listing-wrap">
									<ul>
										...
										<li class="active"><a href="javascript:void(0);"><i class="fa fa-credit-card"></i> My Purchase</a></li>
							...
							<div class="col-sm-9">
								<div class="db-content-wrap">
									<div class="purches-counter">
										<ul>
											<li><a href=""><span>0</span> Purchase History</a></li>
											<li class="active"><a href=""><span>0</span> Purchase Pending</a></li>
										</ul>
									</div>
